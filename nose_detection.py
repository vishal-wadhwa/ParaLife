...
#    # detect faces in the grayscale frame
    ...
    for rect in rects:
        ...
        nose=shape[34]+shape[31]+shape[33]+shape[35]
        nose=nose/4
        #print(nose)
        d = dist.euclidean(nose, (width/2, height/2))
        
        slope = math.atan((float)((nose[1] - height/2)/(nose[0] - width/2)))


      # cv2.line(frame, ((int)(width/2), (int)(height/2), (int)(nose[0]),(int)(nose[1])), (255,0,0), 2)
        cv2.line(frame, ((int)(width/2), (int)(height/2)), ((int)(nose[0]), (int)(nose[1])), (255,0,0), 2)
        c, e = mouse.position()
